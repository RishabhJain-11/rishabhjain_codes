      ...
      <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-816 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <a href="/" className="group relative block h-64 sm:h-80 lg:h-96">
            <span className="absolute inset-0 border-2 border-dashed border-yellow-400"></span>

            <div className="relative flex h-full transform items-end border-2 text-white border-yellow-400 bg-black transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
